...
class AkustikView extends GetView<AkustikController> {
  const AkustikView({super.key});
...
class _AkustikContent extends GetView<AkustikController> {
  const _AkustikContent();
...
class RoutineActivitiesSection extends GetView<AkustikController> {
  final String title;
...
class _BottomNavBar extends StatelessWidget {
  final AkustikController controller;
