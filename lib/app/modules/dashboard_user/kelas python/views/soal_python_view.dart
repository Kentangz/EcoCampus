...
import '../controllers/soal_python_controller.dart';

class PythonQuizView extends GetView<PythonQuizController> {
  const PythonQuizView({Key? key}) : super(key: key);
...
class PythonQuizContent extends GetView<PythonQuizController> {
  const PythonQuizContent({Key? key}) : super(key: key);
...
class _BottomNavBar extends StatelessWidget {
  final PythonQuizController controller;
