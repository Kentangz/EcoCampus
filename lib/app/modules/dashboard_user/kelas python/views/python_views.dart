...
import '../controllers/python_controller.dart';

class PythonClassView extends GetView<PythonClassController> {
  const PythonClassView({Key? key}) : super(key: key);
...
class PythonClassContent extends GetView<PythonClassController> {
  const PythonClassContent({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Icon(
                  TechStackIcons.getIcon(item.techStackIcon ?? "Python"),
                  color: TechStackIcons.getColor(item.techStackIcon ?? "Python"),
                  size: 70),
            ),
          )
        ],
          ...
          Align(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                    Get.toNamed(Routes.PYTHON_MODULE, arguments: {
                      'title': item.title,
  ...
  Widget _buildCategoryItem(QuizModel item) {
    return Material(
      ...
      child: InkWell(
        borderRadius: BorderRadius.circular(10),
        onTap: () {
          Get.toNamed(Routes.PYTHON_QUIZ, arguments: {
            "courseId": controller.courses[0].id,
...
class _BottomNavBar extends StatelessWidget {
  final PythonClassController controller;
