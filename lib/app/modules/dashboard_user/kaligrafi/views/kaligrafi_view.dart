...
class KaligrafiView extends GetView<KaligrafiController> {
  const KaligrafiView({super.key});
...
class _KaligrafiContent extends GetView<KaligrafiController> {
  const _KaligrafiContent();
...
class _BottomNavBar extends StatelessWidget {
  final KaligrafiController controller;
